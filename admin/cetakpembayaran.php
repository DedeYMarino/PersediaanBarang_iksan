<?php 
  ...
  $kode_pembayaran  = isset($_GET['kode_pembayaran']) ? $_GET['kode_pembayaran'] : false;
...
<!-- Setting Margin header/ kop -->
  ...
  <table>
    <tr>
      ...
      <td align="center" style="width: 520px;"><font style="font-size: 18px"><b>CINEMA XXI</b></font>
      <br><br>Jl. xxx</td>
	  <th rowspan="3"><img src="../gambar/logo.png" style="width:100px;height:80px" /></th>
    </tr>
  </table>
  <hr>
  <p align="center" style="font-weight: bold; font-size: 18px;"><u>BUKTI PEMBAYARAN</u></p>
...
FROM  supplier sup WHERE kode_supplier IN (SELECT DISTINCT(kode_supplier) FROM order_pembelian WHERE no_po='$no_po')"); 
    ...
    <table border="0" style="font-size: 10px;">
      ...
      <?php 
      $qgetbank = mysqli_query($koneksi, "SELECT bank FROM pembayaran WHERE pembayaran.no_po='$no_po' "); 
      
      while($value=mysqli_fetch_array($qgetbank))
      {
        $bank=$value['bank'];
      }
      ?>
      <tr>
        <td colspan="4">Telah dibayarkan melalui Bank <b><?=$bank?></b></td>
      </tr>
    </table>
