		...
		<div class="col-sm-12">
			 <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Order Pembelian Barang</h3>
                </div>                
                <div class="box-body">
                				...
                				<tr>
                					<?php 
                					 ...
                					 ?>
                						...
                						<td>                                                                                                                                                                                                          
											<a href="?p=detil&tgl=<?= $row['tanggal']; ?>"><span data-placement='top' data-toggle='tooltip' title='Detail Pembelian'><button    class="btn btn-info">Detail Pembelian</button></span></a>                  
                						</td>
								</tr>    
