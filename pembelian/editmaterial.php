    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2 col-xs-12">
            <div class="box box-primary">
                ...
                <form method="post"  action="edit_proses_material.php" class="form-horizontal">
                    <div class="box-body">
                    <div class="row">
                        <div class="col-md-2">
                            <a href="index.php?p=material" class="btn btn-primary"><i class="fa fa-backward"></i> Kembali</a> 
                        </div>
                        <br><br>
                    </div>   
                        ...
                        <div class="form-group ">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select id="id_jenis" required="isikan dulu" class="form-control" name="id_jenis">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="number" class="form-control" value="<?= $row2['harga']; ?>" name="harga">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="jenis_brg" class="col-sm-offset-1 col-sm-3 control-label">Suplier</label>
                            <div class="col-sm-4">
                                ...
                                <?php  
                                    ...
                                    ?>                                        
                                        <option <?php if($row2['suplier']==$row['kode_supplier']) echo "selected"; ?>  value="<?= $row['kode_supplier']; ?>"><?= $row['nama_supplier']; ?></option>
                                    <?php endwhile; } ?>                                      
                                </select>
                            </div>
                        </div>
