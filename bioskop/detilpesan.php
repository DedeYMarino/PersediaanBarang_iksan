<?php  
    ...
    if (isset($_GET['tgl'])) {
        ...
        $query = mysqli_query($koneksi, "SELECT  permintaan.id_permintaan, permintaan.no_order, permintaan.kode_brg, nama_brg, jumlah, satuan, status FROM permintaan INNER JOIN 
        stokbarang ON permintaan.kode_brg = stokbarang.kode_brg  WHERE tgl_permintaan='$tgl' AND no_order='$no_order' AND unit='$_SESSION[username]' ");
        ...
        <div class="col-sm-12">
             <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Data Order Barang <?php echo tanggal_indo($tgl); ?></h3>
                </div>                
                <div class="box-body">                   
