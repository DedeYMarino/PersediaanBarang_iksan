  ...
  <table class="tabel2">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="text-align: center; width=30px;"><?php echo $data['tgl_masuk']; ?></td>
        ...
        <td style="text-align: center; width=30px;"><?php echo $data['keluar']; ?></td>
        <td style="text-align: center; width=30px;"><?php echo $data['sisa']; ?></td> 
        <td style="text-align: center; width=30px;"><?php echo $data['suplier']; ?></td>
