...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          <a href="index.php">
		    ...
		    <li><a href="index.php?p=user"><i class="fa fa-user"></i> <span>Olah Data User</span></a></li>
        <li><a href="index.php?p=gantipassword"><i class="fa fa-key"></i> <span>Ganti Password</span></a></li>
        <li><a href="../logout.php"><i class="fa fa-sign-out"></i> <span>Logout</span></a></li>        
      </ul>
    </section>
       <!-- <li><a href="index.php?p=datapesanan"><i class="fa fa-files-o"></i> <span>Data Order Barang</span></a></li>
		    <li><a href="index.php?p=suplier"><i class="fa fa-user"></i> <span>Data Suplier</span></a></li>
        <li><a href="index.php?p=bioskop"><i class="fa fa-user"></i> <span>Data Bioskop</span></a></li>
        <li><a href="index.php?p=pembayaran"><i class="fa fa-dollar"></i> <span>Pembayaran</span></a></li>
		<li class="treeview">
          <a href="#">
        ...
        <li><a href="index.php?p=jurnal"><i class="fa fa-files-o"></i> <span>Jurnal</span></a></li>
        <li><a href="index.php?p=gantipassword"><i class="fa fa-key"></i> <span>Ganti Password</span></a></li>
        <li><a href="../logout.php"><i class="fa fa-sign-out"></i> <span>Logout</span></a></li>        
      </ul>
    </section>
  ...
  <footer class="main-footer">
	<!-- <marquee hspace="40" width="full-width">Admin Gudang mengolah data user dan data stok material teknik.</marquee>
