...
<!-- Setting Margin header/ kop -->
  ...
  <hr>
  <p align="center" style="font-weight: bold; font-size: 18px;"><u>BUKTI PENGELUARAN ORDER BARANG</u></p>
  <br><br>
  <h4 style="color: black; text-align: center;">Pengeluaran Permintaan Barang dari Bioskop : <?= $unit; ?></h4>
   ...
   <table class="tabel2">
    ...
    <tbody>
      <?php
       ...
       $query = mysqli_query($koneksi, "SELECT permintaan.keterangan, permintaan.kode_brg, unit, nama_brg, jumlah, satuan, status, tgl_permintaan FROM permintaan INNER JOIN stokbarang ON permintaan.kode_brg = stokbarang.kode_brg  WHERE unit='$unit' AND status=1 AND tgl_permintaan='$tgl' "); 
      $i   = 1;
  ...
  <p>Pada hari ini tanggal : <b> <?=  tanggal_indo($tgl); ?></b> telah dikeluarkan Surat Permintaan Barang.</p>
  <p></p>
  </div>
 ...
 try
{
    ...
    $html2pdf->Output('bukti_order_pengeluaran_barang.pdf');
}
