  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">      
      <ul class="sidebar-menu">
        <li class="header"><h4 class="text-center">Receiving</h4></li>
    ...
    <li class="treeview">
		...
		<li><a href="index.php?p=datapesanan"><i class="fa fa-files-o"></i> Approval Permintaan Barang</a></li>
    <li><a href="index.php?p=datapembelian"><i class="fa fa-files-o"></i> Approval Order Pembelian</a></li>
  </ul></li>
  <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i>
          ...
          <ul class="treeview-menu">
		<li><a href="index.php?p=pemasukan"><i class="fa fa-files-o"></i> Laporan Pemasukan Barang</a></li>
    <li><a href="index.php?p=disetujui"><i class="fa fa-files-o"></i> Laporan Pengeluaran Barang</a></li>  
    </ul></li> 
    <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i>
          ...
          <ul class="treeview-menu">
            <?php  
                                    include "../fungsi/koneksi.php";
                                    $q = mysqli_query($koneksi, "select * from jenis_barang");
		...
		<!--<li><a href="index.php?p=suplier"><i class="fa fa-file-o"></i> <span>Data Suplier</span></a></li>-->
    <!--<li><a href="index.php?p=bioskop"><i class="fa fa-file-o"></i> <span>Olah Data Bioskop</span></a></li>-->
    <li><a href="index.php?p=cetakpesanan"><i class="fa fa-print"></i> Cetak Tanda Terima</a></li>     
    <li><a href="cetakjurnal.php" target="_blank"><i class="fa fa-print"></i> <span>Cetak Jurnal</span></a></li>  
