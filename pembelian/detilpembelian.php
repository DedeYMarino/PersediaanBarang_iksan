                                     ...
                                     ?>
                                        ...
                                        <td > <?php
                                         ...
                                         <td>                                            
                                                    ...
                                                    <a  href="?p=hapus&id=<?= $row['id_order_pembelian']; ?>&tgl=<?= $tgl; ?>"><span data-placement='top' data-toggle='tooltip' title='Hapus'><button   class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus ?')">Hapus</button></span></a>            
