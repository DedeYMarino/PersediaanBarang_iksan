<?php  
    ...
    if (isset($_GET['tgl']) && isset($_GET['unit'])) {
        ...
        $query = mysqli_query($koneksi, "SELECT permintaan.tgl_permintaan, permintaan.no_order, permintaan.id_permintaan, permintaan.kode_brg, nama_brg, jumlah, satuan, status FROM permintaan INNER JOIN 
        stokbarang ON permintaan.kode_brg = stokbarang.kode_brg  WHERE tgl_permintaan='$tgl' AND no_order='$no_order' AND unit='$unit' AND status!=1");
        ...
        <div class="col-sm-12">
             <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">DETAIL APPROVAL DATA PERMINTAAN BARANG DARI   <?php echo $unit; ?></h3>
                </div>                
                <div class="box-body">                   
                                    ...
                                    <?php 
                                     ...
                                     ?>
                                        ...
                                        <td>                                            
                                                    ...
                                                    <a  href="?p=editpesan&id=<?=$row['id_permintaan']; ?>"><span data-placement='top' data-toggle='tooltip' title='Edit'><button   class="btn btn-primary" >Edit</button></span></a>   <?php } ?>         
