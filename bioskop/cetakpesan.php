        ...
        <div class="col-sm-12">
             <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Cetak Bukti Order Barang</h3>
                </div>                
                <div class="box-body">
                                ...
                                <tr>
                                    <?php 
                                     ...
                                     ?>
                                        ...
                                        <td>        
										<a target="_blank" href="cetakpesanan.php?&tgl=<?= $row['tgl_permintaan']; ?>&unit=<?= $row['unit']; ?>"><span data-placement='top' data-toggle='tooltip' title='Cetak'><button class="btn btn-success"><i class="fa fa-print"> Cetak</i></button></span></a>                  
                                        </td>
								</tr>        
