...
<head>
  ...
  <title>Aplikasi Order & Terima Barang</title>
...
<header class="main-header">
	<div class="logo">
	 <span class="logo-lg"><b>BIOSKOP 21</b></span>
	</div>
  ...
  <aside class="main-sidebar">    
    <section class="sidebar">      
      <ul class="sidebar-menu">
        <li class="header"><h4 class="text-center">Bioskop <?=  $_SESSION['username']; ?></h4></li>
      ...
      <li><a href="index.php?p=datapesanan"><i class="fa fa-files-o"></i> Order Permintaan Barang</a></li>
      <li><a href="index.php?p=material"><i class="fa fa-files-o"></i> Data Stok Barang</a></li>
      <!--<li><a href="index.php?p=cetakpesanan"><i class="fa fa-print"></i> Cetak Bukti Order</a></li>-->
      <!--<li class="treeview">
          <a href="#">
