<?php  
      ...
      if (isset($_GET['aksi']) && isset($_GET['id'])) {
        ...
        if ($_GET['aksi'] == 'edit') {
            header("location:?p=editakun&id=$id");
        } else if ($_GET['aksi'] == 'hapus') {
            header("location:?p=hapusakun&id=$id");
        } 
    }
		...
		<div class="col-sm-12">
			 <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Olah Data Akun</h3>
                </div>                
                <div class="box-body">
               <div class="row">
                    <div class="col-md-2">
                        <a href="index.php?p=tambahakun" class=" btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a> 
                    </div>
                    <br><br>
                </div>                  
